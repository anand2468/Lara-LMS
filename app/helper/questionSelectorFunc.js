...
async function example() {
  const inputArray = [
    { "topic": "series", "no_of_questions": 5 },
    { "topic": "math", "no_of_questions": 3 },
    { "topic": "logic", "no_of_questions": 10 }
  ];
...
async function testWithSampleData() {
  const inputArray = [
    { "topic": "series", "no_of_questions": 2 },
    { "topic": "math", "no_of_questions": 1 }
  ];
  ...
  const service = new QuestionService("mongodb://localhost:27017", "quiz_database");
